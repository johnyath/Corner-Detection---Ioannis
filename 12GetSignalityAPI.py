...
for game in available_games:
    # print(game['id'])
    # home_team_name = dicts.OptaToSignality(game['team_home_name'])
    # away_team_name = dicts.OptaToSignality(game['team_away_name'])
    ...
    for game_half in game_halves:
        ...
        for file in files_list:
            ...
            filename = save_dir1+file_name + game_half + '-' + file + '.json'
